...
def _resnet(arch, block, layers, pretrained, progress, model_path, **kwargs):
...
def resnet34(pretrained=False, progress=True, model_path=None, **kwargs):
...
def resnet50(pretrained=False, progress=True, model_path=None, **kwargs):
